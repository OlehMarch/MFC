...
// Chapter9and10.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CChapter9and10App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CChapter9and10App

CChapter9and10App::CChapter9and10App()
{
...
// Единственный объект CChapter9and10App

CChapter9and10App theApp;


// инициализация CChapter9and10App

BOOL CChapter9and10App::InitInstance()
{

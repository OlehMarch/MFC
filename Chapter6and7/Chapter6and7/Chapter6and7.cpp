...
// Chapter6and7.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CChapter6and7App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CChapter6and7App

CChapter6and7App::CChapter6and7App()
{
...
// Единственный объект CChapter6and7App

CChapter6and7App theApp;


// инициализация CChapter6and7App

BOOL CChapter6and7App::InitInstance()
{
